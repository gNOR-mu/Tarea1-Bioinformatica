 ...
 * **Cálculos y Creación de Objetos Estáticos (Static Allocation Only):** Solo se permite la creación de objetos y la ejecución de cálculos pesados (como procesamiento de streams o inicialización de estructuras) de forma estática durante la carga de las clases. De este modo, cualquier overhead de inicialización ocurre una única vez al arrancar la aplicación, garantizando que el ciclo caliente de simulación quede libre de estas penalizaciones.
